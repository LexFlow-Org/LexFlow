...
L'APK mantiene il certificato Android della versione 1.0.0 e della precedente 1.0.1 e aumenta il codice versione a 252. Su un dispositivo dove era installato quell'APK, installa il nuovo pacchetto come aggiornamento senza disinstallare prima l'applicazione. La nuova build corregge la visibilità del modulo password sui display stretti e gli stili bloccati dalla CSP; disabilita inoltre esplicitamente la diagnostica WebView nelle build release. Il passaggio da una versione all'altra va verificato con dati fittizi prima dell'uso professionale.
